...
public class Lang
{
    ...
    public static final String COMMAND_SENDER_MUST_BE_PLAYER = "§cEste comando não pode ser usado pelo console.";
    ...
    public static final String COMMAND_TOO_FEW_ARGUMENTS = "§iVocê usou argumentos inválidos para este comando.";
    public static final String COMMAND_TOO_MANY_ARGUMENTS = "§iVocê usou muitos argumentos para este comando.";
    public static final String COMMAND_TOO_MANY_ARGUMENTS2 = "§iTente usar §6/f ajuda §epara obter ajuda.";
    ...
    public static final String COMMAND_TOO_MANY_TAB_SUGGESTIONS = "§cHá §c%d §cpossibilidades de auto-completamento para isto. Tente ser mais específico.";
}